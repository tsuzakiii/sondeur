...
const CONTENT = {
  ja: {
    ...
    plans: [
      ...
      { name: "Standard", price: "$12/月", detail: "250 ノード/月" },
      { name: "Pro", price: "$24/月", detail: "600 ノード/月" },
    ],
  ...
  en: {
    ...
    plans: [
      ...
      { name: "Standard", price: "$12/mo", detail: "250 nodes/mo" },
      { name: "Pro", price: "$24/mo", detail: "600 nodes/mo" },
    ],
