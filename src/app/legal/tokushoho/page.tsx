 ...
 * 住所・電話番号は消費者庁ガイドラインに基づく「請求があったら遅滞なく開示」方式。
 */
...
const ROWS: { label: string; value: string }[] = [
  ...
  { label: "電話番号", value: "請求があったら遅滞なく開示します（お問い合わせは下記メールアドレスへ）" },
  ...
  { label: "商品代金以外の必要料金", value: "なし（インターネット接続に伴う通信費はお客様のご負担となります）" },
  ...
  { label: "サービスの提供時期", value: "決済完了後、直ちにご利用いただけます" },
  {
    label: "解約・キャンセル",
    value:
      "アカウントメニューの「プラン管理」からいつでも解約できます。解約後も当該請求期間の終了までご利用いただけます。デジタルサービスの性質上、日割りでの返金は行いません",
  },
  { label: "動作環境", value: "モダンブラウザ（Chrome / Safari / Edge / Firefox）の最新版" },
  { label: "特別条件", value: "無料プランで事前に機能をお試しいただけます" },
];
