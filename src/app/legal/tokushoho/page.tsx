 ...
 * 運営者情報 (氏名・メール) は 2026-07-10 に本人が記入済み。
 * 住所・電話番号は消費者庁ガイドラインに基づき、開示請求を受けた場合に遅滞なく開示する方式。
 */

const ROWS: { label: string; value: string }[] = [
  { label: "販売事業者", value: "松崎 翔太" },
  { label: "運営統括責任者", value: "松崎 翔太" },
  { label: "所在地", value: "法令に基づき、取引時に所在地の開示を求められた場合は、遅滞なく開示いたします" },
  {
    label: "電話番号",
    value:
  ...
  { label: "販売URL", value: "https://sondeur.app" },
  {
    label: "販売価格",
    value:
      "Standard プラン: 月額7米ドル / Pro プラン: 月額14米ドル（表示価格は米ドル建てです。税金が適用される場合があります）",
  },
  {
    label: "商品代金以外の必要料金",
    value:
      "税金、インターネット接続に伴う通信費、為替手数料その他金融機関等が定める手数料はお客様のご負担となります",
  },
  { label: "申込期間", value: "申込期間の定めはありません" },
  {
    label: "利用制限",
    value:
      "Free プラン: 20ノード/月 / Standard プラン: 100ノード/月 / Pro プラン: 300ノード/月（不正利用または過剰利用が確認された場合、利用規約に基づき利用を制限することがあります）",
  },
  { label: "支払方法", value: "クレジットカード（Stripe による決済）" },
  { label: "支払時期", value: "初回はお申し込み時に課金され、以後は各請求期間の更新日に1か月ごとに自動課金されます" },
