...
const ROWS: { label: string; value: string }[] = [
  ...
  { label: "販売URL", value: "https://sondeur.vercel.app" },
  {
    label: "販売価格",
    value:
      "Standard プラン: 月額12米ドル / Pro プラン: 月額24米ドル（表示価格は米ドル建てです。税金が適用される場合があります）",
  },
  {
    label: "商品代金以外の必要料金",
    value:
  ...
  { label: "申込期間", value: "申込期間の定めはありません" },
  {
    label: "利用制限",
    value:
      "Free プラン: 20ノード/月 / Standard プラン: 250ノード/月 / Pro プラン: 600ノード/月（不正利用または過剰利用が確認された場合、利用規約に基づき利用を制限することがあります）",
  },
